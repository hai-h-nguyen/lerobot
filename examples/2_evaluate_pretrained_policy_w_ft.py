...
output_directory = Path("output/eval/peg-insertion-square-w-ft")
...
pretrained_policy_path = Path("output/peg-insertion-square-windowed-ft/checkpoints/last/pretrained_model")
